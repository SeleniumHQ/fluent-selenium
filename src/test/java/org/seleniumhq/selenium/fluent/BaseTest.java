...
public class BaseTest {
    ...
    protected void setupExpecations(String name) {
    	setupExpecations(name, name);
    }
    
    protected void setupExpecations(String byName, String tagName)
    {
    ...
    protected void setupExpecations2(String button) {
    	setupExpecations2(button, button);
    }
    
    protected void setupExpecations2(String byName, String tagName)
    {
    	when(wd.findElement(By.tagName(byName))).thenReturn(we);
        when(we.getTagName()).thenReturn(tagName);
