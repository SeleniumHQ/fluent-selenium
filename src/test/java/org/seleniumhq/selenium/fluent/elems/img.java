...
public class img extends BaseTest {
    ...
    @Test
    public void recording_img_functionality() {
    ...
    @Test
    public void recording_imgs_functionality() {
    ...
    @Test
    public void recording_img_mismatched() {

        FluentRecorder recording = new FluentRecorder();

        new RecordingFluentWebDriverFactoryImpl().recordTo(recording).img(By.linkText("mismatching_tag_name"))
                .clearField();
