...
public class h4 extends BaseTest {
    ...
    @Test
    public void recording_h4_functionality() {
    ...
    @Test
    public void recording_h4s_functionality() {
    ...
    @Test
    public void recording_h4_mismatched() {

        FluentRecorder recording = new FluentRecorder();

        new RecordingFluentWebDriverFactoryImpl().recordTo(recording).h4(By.linkText("mismatching_tag_name"))
                .clearField();
