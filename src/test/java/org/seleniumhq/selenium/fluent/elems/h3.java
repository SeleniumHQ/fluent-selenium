...
public class h3 extends BaseTest {
    ...
    @Test
    public void recording_h3_functionality() {
    ...
    @Test
    public void recording_h3s_functionality() {
    ...
    @Test
    public void recording_h3_mismatched() {

        FluentRecorder recording = new FluentRecorder();

        new RecordingFluentWebDriverFactoryImpl().recordTo(recording).h3(By.linkText("mismatching_tag_name"))
                .clearField();
