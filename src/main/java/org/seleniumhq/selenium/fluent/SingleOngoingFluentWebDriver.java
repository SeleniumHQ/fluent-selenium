...
public class SingleOngoingFluentWebDriver extends OngoingFluentWebDriver {
    public SingleOngoingFluentWebDriver(WebDriver delegate, List<WebElement> currentElements) {
